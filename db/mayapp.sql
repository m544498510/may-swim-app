...
CREATE TABLE `t_perm` (
  ...
  PRIMARY KEY (`perm_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Ȩ�ޱ�';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='һ��ѵ��';
...
CREATE TABLE `t_set` (
  ...
  `set_index` smallint(6) NOT NULL COMMENT 'Ϊ0ʱ����total���ݡ�\r\n            ����0���Ƿ�������',
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='����ѵ��';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Ӿ�˱�';
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='�û�Ȩ�޹�����';
